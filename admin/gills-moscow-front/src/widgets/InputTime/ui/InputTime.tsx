...
const InputTime: React.FC<InputTimeProps> = ({ value, onTimeSelect, bookingTime, isError, setValue, field, disabled, wfull }) => {
    ...
    return (
        <div className="time-picker-wrapper" style={{ width: wfull ? '100%' : '' }}>
            <input
                type="text"
