 ...
 * @group api
 */
class CreateRoomTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/rooms';
    ...
    // TODO TEST
    // public function testCreateRoomWithInvalidFields(): void
    // {
    //     $data = [
    ...
    // public function testGivenHaveNoAccess_CannotCreateRoom(): void
    // {
