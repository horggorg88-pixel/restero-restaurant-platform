 ...
 * @group api
 */
class CreateTableTest extends ApiTestCase
{
    protected string $endpoint = 'post@v1/tables';
    ...
    // TODO TEST
    // public function testCreateTableWithInvalidFields(): void
    // {
    //     $data = [
    ...
    // public function testGivenHaveNoAccess_CannotCreateTable(): void
    // {
